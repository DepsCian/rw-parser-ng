...
describe("dff parsing - wuzimu", () => {
  ...
  test("frames - rotation matrices", () => {
    ...
    expect(frameList!.frames[10].rotationMatrix).toStrictEqual({
      right: {
        x: expect.closeTo(0.9785407781600952, FLOATING_POINT_ERROR),
        y: expect.closeTo(0.20605318248271942, FLOATING_POINT_ERROR),
        z: expect.closeTo(0.0, FLOATING_POINT_ERROR),
      },
      up: {
        x: expect.closeTo(-0.20605315268039703, FLOATING_POINT_ERROR),
        y: expect.closeTo(0.97854083776474, FLOATING_POINT_ERROR),
        z: expect.closeTo(0.0, FLOATING_POINT_ERROR),
      },
      at: {
