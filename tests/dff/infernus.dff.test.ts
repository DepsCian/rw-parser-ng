...
describe("dff parsing - infernus", () => {
  ...
  test("geometries - texture mapping", () => {
    ...
    expect(geometryList!.geometries[0].textureMappingInformation[0][0]).toStrictEqual({
      u: 0,
      v: 0,
    });
    expect(geometryList!.geometries[0].textureMappingInformation[0][3]).toStrictEqual({
      u: 0,
      v: 0,
    });
  ...
  test("geometries - materials", () => {
    ...
    expect(geometryList!.geometries[0].materialList.materialData[0].color).toStrictEqual({
      r: 0,
      g: 0,
      b: 0,
      a: 255,
    ...
    expect(geometryList!.geometries[0].materialList.materialData[1].color).toStrictEqual({
      r: 255,
      g: 255,
      b: 255,
      a: 255,
    ...
    expect(geometryList!.geometries[0].materialList.materialData[3].ambient).toBeCloseTo(
      0.4000000059604645,
